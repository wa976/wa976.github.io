  ...
  <div style="flex: 1;">
    <div style="display: flex; align-items: flex-start; margin-bottom: 40px;">
      ...
      <div>
        ...
        <br>
        <b>Email:</b> wa3229433@gmail.com<br>
        <b>
    ...
    - **Ph.D. in Department of Artificial Intelligence, SEOULTECH** (Mar. 2026 ~ Present)
    - **M.S. Department of Artificial Intelligence, SEOULTECH** (Mar. 2024 ~ Feb.2026)
    - **B.S. Department of Electronic Engineering, SEOULTECH** (Mar. 2017 ~ Feb. 2024)

    <hr class="section-divider">

    <h2 id="publications">Publications</h2>
    <i>CHI 2026</i> - <b> Reading the Mood Behind Words: Integrating Prosody-Derived Emotional Context into Socially Responsive VR Agents</b> (SY Jeong, YS Na, **SG Jeong**, JW Jeong, SE Kim) <br><br>


    <i>ICASSP 2026</i> - <b> PC-MCL: Patient-Consistent Multi-Cycle Learning With Multi-Label Bias Correction for Respiratory Sound Classification</b> (**SG Jeong**, SE Kim) <br><br>
